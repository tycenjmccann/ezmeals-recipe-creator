...
def lambda_handler(event, context):
    """Main Lambda handler for S3 operations - FIXED FOR BEDROCK AGENT FORMAT."""
    try:
        ...
        if function_name == 'upload_recipe_to_s3':
            recipe_data = parsed_params.get('recipe_data')
            recipe_name = parsed_params.get('recipe_name')
        ...
        # FIXED: Return in correct Bedrock agent format (same as your working database functions)
